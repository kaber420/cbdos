...
enum class StrId : uint16_t {
    ...
    // PowerConfig
    STR_PWR_SEC1 = 0x0081,
    STR_PWR_TIMEOUT = 0x0082,
    STR_PWR_TIMEOUTS = 0x0083,
    STR_PWR_SEC2 = 0x0084,
    STR_PWR_BTN_SCR_OFF = 0x0085,
    STR_PWR_BTN_LIGHT = 0x0086,
    STR_PWR_BTN_DEEP = 0x0087,
    STR_PWR_BTN_RESTART = 0x0088,
    STR_PWR_TOAST_SCR_OFF = 0x0089,
    STR_PWR_TOAST_LIGHT = 0x008A,
    STR_PWR_TOAST_DEEP = 0x008B,
    STR_PWR_TOAST_RESTART = 0x008C,
    STR_PWR_TOAST_TOUT_OFF = 0x008D,
    STR_PWR_TOAST_TOUT_ON = 0x008E,

    // TimeConfig
    STR_TIME_TZ = 0x008F,
    STR_TIME_DST = 0x0090,
    STR_TIME_DST_SUB = 0x0091,
    STR_TIME_NTP = 0x0092,
    STR_TIME_NTP_SUB = 0x0093,
    STR_TIME_NTP_SRV = 0x0094,
    STR_TIME_SAVE = 0x0095,
    STR_TIME_SYNC_NOW = 0x0096,
    STR_TIME_ST_WIFI = 0x0097,
    STR_TIME_ST_TOWER = 0x0098,
    ...
    STR_TERM_MODE = 0x00AE,
    STR_TERM_MODE_UART = 0x00AF,

    STR_UTIL_TITLE = 0x00B0,
    STR_UTIL_NOTES = 0x00B1,
    STR_UTIL_CALC = 0x00B2,
    STR_UTIL_SW = 0x00B3,
    STR_UTIL_POMO = 0x00B4,

    STR_FLASH_TITLE = 0x00B5,
    STR_FLASH_TARGET = 0x00B6,
    STR_FLASH_FIRMWARE = 0x00B7,
    STR_FLASH_SELECT_BIN = 0x00B8,
    STR_FLASH_BTN_FLASH = 0x00B9,
    STR_FLASH_BTN_VERIFY = 0x00BA,
