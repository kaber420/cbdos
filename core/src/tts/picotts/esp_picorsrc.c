...
pico_Status esp_pico_loadResource(pico_System sys, const void *raw, pico_Resource *outResource)
{
...
pico_Status esp_pico_unloadResource(pico_System sys, pico_Resource *inResource)
{
