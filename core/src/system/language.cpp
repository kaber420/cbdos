...
static const char* const lang_es[] = {
    ...
    // PowerConfig 0x0081-0x008E
    "Ahorro de Bateria por Inactividad:",
    "Auto-Apagado de Pantalla",
    "Desactivado\n1 Minuto\n3 Minutos\n5 Minutos\n10 Minutos",
    "Acciones de Energia:",
    "Apagar Pantalla (Mantener tareas fondo)",
    "Suspensión (Light Sleep)",
    "Suspensión Profunda (Deep Sleep - LP Core)",
    "Reiniciar Sistema (Reboot)",
    "Pantalla Apagada (Toque para encender)",
    "Entrando a Suspensión (Light Sleep)...",
    "Entrando a Suspensión Profunda (Deep Sleep)...",
    "Reiniciando sistema...",
    "Auto-Apagado de Pantalla Desactivado",
    "Auto-Apagado Pantalla: %u min",
    // TimeConfig 0x008F-0x009A
    "Zona Horaria (Huso Horario):",
    "Horario de Verano (DST)",
    "Adelanta 1 hora (+3600s)",
    "Sincronizacion Automatica Unificada",
    "Wi-Fi (Internet) o Balizas de Torre Federadas",
    "Servidor de Tiempo NTP:",
    "Guardar Ajustes",
    "Sincronizar Ahora",
    "Sincronizado (Wi-Fi SNTP)",
...
static const char* const lang_en[] = {
    ...
    "Disabled\n1 Minute\n3 Minutes\n5 Minutes\n10 Minutes",
    "Power Actions:",
    "Turn Off Screen (Keep tasks running)",
    "Light Sleep",
    "Deep Sleep (LP Core)",
    ...
    "Screen Auto-Off: %u min",
    // TimeConfig 0x008F-0x009A
    "Timezone:",
    "Daylight Saving Time (DST)",
    "Move forward 1 hour (+3600s)",
    "Unified Auto-Sync",
    "Wi-Fi (Internet) or Federated Tower Beacons",
    "NTP Time Server:",
    "Save Settings",
    "Sync Now",
    "Synced (Wi-Fi SNTP)",
